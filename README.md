<p align="center">
  <img src="https://img.shields.io/badge/SmartEnroll-UTH-00f2fe?style=for-the-badge&logo=github" alt="SmartEnroll Logo" />
</p>

<h1 align="center">🎓 SmartEnroll UTH</h1>

<p align="center">
  <strong>Hệ thống Hỗ trợ Đăng ký Học phần Tự động Thông minh dành cho Sinh viên UTH</strong>
</p>

<p align="center">
  <a href="https://github.com/DiepTuHuy/SmartEnroll/stargazers"><img src="https://img.shields.io/github/stars/DiepTuHuy/SmartEnroll?style=for-the-badge&color=gold" alt="GitHub Stars" /></a>
  <a href="https://github.com/DiepTuHuy/SmartEnroll/network/members"><img src="https://img.shields.io/github/forks/DiepTuHuy/SmartEnroll?style=for-the-badge&color=violet" alt="GitHub Forks" /></a>
  <a href="https://github.com/DiepTuHuy/SmartEnroll/releases"><img src="https://img.shields.io/github/v/release/DiepTuHuy/SmartEnroll?style=for-the-badge&color=green" alt="Latest Release" /></a>
  <a href="https://github.com/DiepTuHuy/SmartEnroll/blob/main/LICENSE"><img src="https://img.shields.io/github/license/DiepTuHuy/SmartEnroll?style=for-the-badge&color=blue" alt="License" /></a>
</p>

<p align="center">
  <img src="https://img.shields.io/badge/Python-3.8%2B-3776AB?style=flat-square&logo=python&logoColor=white" alt="Python" />
  <img src="https://img.shields.io/badge/React-18.0%2B-202020?style=flat-square&logo=react&logoColor=61DAFB" alt="React" />
  <img src="https://img.shields.io/badge/Flask-2.0%2B-000000?style=flat-square&logo=flask&logoColor=white" alt="Flask" />
  <img src="https://img.shields.io/badge/Selenium-4.0%2B-43B02A?style=flat-square&logo=selenium&logoColor=white" alt="Selenium" />
</p>
...
### 1. 🕵️ Trình tự động hóa Đăng nhập & Lấy Token siêu tốc (`auto_config.py`)
...
*   **Tự đóng trình duyệt:** Tự động tắt trình duyệt Chrome và lưu cấu hình vào thư mục người dùng (`~/.smartenroll_config.json`) chỉ sau 2 giây.
...
```mermaid
graph TD
    A[React Web Client: 5001/5173] <-->|API Requests / Proxy| B[Flask Backend: 5001]
    B <-->|Selenium CDP Sniffer| C[Google Chrome]
    B <-->|Reverse Proxy API| D[UTH School Portal API]
```
...
> [!CAUTION]
> **Lỗi Phân quyền Ghi cấu hình trên macOS (AppTranslocation)**
> Nếu bạn tải bản `.zip` từ mục Release của GitHub về thư mục `Downloads` và giải nén chạy file `SmartEnroll.app`, macOS có thể gắn cờ cách ly bảo mật khiến ứng dụng không thể ghi file cấu hình. Hãy chạy lệnh dưới đây trong Terminal để mở khóa ứng dụng:
> ```bash
> xattr -cr ~/Downloads/SmartEnroll.app
> chmod +x ~/Downloads/SmartEnroll.app/Contents/MacOS/SmartEnroll
> ```
